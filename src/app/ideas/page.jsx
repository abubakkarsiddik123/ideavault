  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900 md:flex-row">
          <input
            type="text"
        ...
        {data.length === 0 && (
          <div className="rounded-2xl border border-dashed border-gray-300 bg-white py-16 text-center dark:border-gray-700 dark:bg-gray-900">
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              No startup ideas have been shared yet.
            </p>
          </div>
        )}
      </section>
